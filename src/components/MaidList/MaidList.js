...
export default function MaidList() {
  ...
  const totalPageZeroCase = () => {
    if (totalPage === 0) {
      toast.error("Hiện chưa có người giúp việc nào");
    }
  };
  const defaultFilter = {
    electrical: false,
  ...
  return (
    <>
      <div id="maid-container" className="h-max min-h-full w-full">
        ...
        <div className="flex flex-row min-h-screen">
          <div className="flex flex-col w-[20%] items-center border-r-[5px] border-black min-h-full">
            <div className="border-b-[3px] border-black w-full text-center text-[40px] font-bold">
              <span>Đánh giá</span>
            </div>
            <div className="h-[20%] border-b-[3px] border-black w-full">
              <div className="flex flex-col py-3 items-center h-full w-full font-bold text-[30px] gap-4">
            ...
            <div className="h-[20%] border-b-[3px] border-black w-full py-3">
              <div className="flex flex-col items-center h-full w-full font-bold text-[30px] gap-4">
                {/* <div className="flex flex-row w-8/12 items-center">
                    <div className="w-2/12">
                      <div className="bg-[#D9D9D9] w-[24px] h-[24px]">
                ...
                <div className="flex flex-row w-8/12 items-center">
                  ...
                  <div className="grow">
                    <label htmlFor="food">Nấu ăn</label>
                  </div>
                </div>
                <div className="flex flex-row w-8/12 items-center">
                  <div className="w-2/12">
                  ...
                  <div className="grow">
                    <label htmlFor="care">Chăm sóc trẻ</label>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="text-center">
                <span>
                  <select
                    ...
                    className="my-[10px] pl-[10px] pr-[90px] text-[30px] bg-gray-200 mt-4 font-bold"
                  >
